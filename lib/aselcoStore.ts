...
export const ASELCO_ACCOUNTS_DB: Record<string, AselcoAccount> = {
  "15-3029-8812": {
    ...
    address: "National Highway, Bayugan City, Agusan del Sur (Bayugan Area Office)",
  ...
  "09-1102-4491": {
    ...
    address: "Barangay Poblacion, Talacogon, Agusan del Sur (Talacogon Area Office)",
    billingPeriod: "July 2026",
    kwhConsumed: 98,
    amountDue: 980.0,
    dueDate: "2026-08-20",
  ...
  "18-9901-4432": {
    ...
    address: "Zone 2, Trento, Agusan del Sur (Trento Area Office)",
    billingPeriod: "July 2026",
    kwhConsumed: 215,
    amountDue: 2150.5,
    dueDate: "2026-08-18",
